...
//
//    // Основной метод для добавления товара
...
//    WarehouseItemDto addWarehouseItemRoot(@RequestBody WarehouseItemDto itemDto);
//
...
//    WarehouseItemDto addQuantityToWarehouse(@RequestBody WarehouseItemDto itemDto);
//}